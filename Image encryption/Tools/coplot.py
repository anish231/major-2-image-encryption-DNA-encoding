...
def coplot_horizontal(loc, output, name):
    ...
    plt2.clf()  #The clf() function in pyplot module of matplotlib library is used to clear the current figure.
    ...
    plt2.scatter(list_of_pixels_of_x, list_of_pixels_of_y,
                 label='Pixel', color='k', s=2, edgecolors='r')  #The scatter() method in the matplotlib library is used to draw a scatter plot.
